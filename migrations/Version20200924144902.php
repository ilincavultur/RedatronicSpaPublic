 ...
 */
final class Version20200924144902 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reception ADD adults INT DEFAULT NULL, ADD children INT DEFAULT NULL, ADD total_pers INT DEFAULT NULL, ADD total_access INT DEFAULT NULL, ADD total_services INT DEFAULT NULL, ADD total_sum INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reception DROP adults, DROP children, DROP total_pers, DROP total_access, DROP total_services, DROP total_sum');
    }
}
