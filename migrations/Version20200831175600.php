 ...
 */
final class Version20200831175600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reception (id INT AUTO_INCREMENT NOT NULL, rfid VARCHAR(255) NOT NULL, type TINYINT(1) NOT NULL, age INT NOT NULL, packages LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', products LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('DROP TABLE membership_product');
        $this->addSql('DROP TABLE package_product');
        $this->addSql('ALTER TABLE circuit CHANGE is_open is_open TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE circuit CHANGE is_open is_open TINYINT(1) DEFAULT NULL');
    }
}
