 ...
 */
final class Version20200901100847 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE reception ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL, DROP CreatedAt, DROP UpdatedAt');
    }
